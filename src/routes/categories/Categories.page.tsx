...
const Categories = ({ fsdh }: { fsdh: FileSystemDirectoryHandle }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      fileInputLabelRef.current.removeEventListener("dragleave", dragLeave);
    };
  }, []);
      ...
      <div id="onboard">
        <div className="decide">
          ...
          <div className="actions">
            ...
            <button tabIndex={2} onClick={() => navigate("/categories/editor")}>
        ...
        <div className="exportInfoContainer">
          <div className="exportInfo">
            ...
            <div className="categories">
              ...
              <span>
                {exportInfo.categoriesDone}/{exportInfo.categoriesTotal}
              </span>
            </div>
            <div className="currentFile">
              ...
              <div className="progressBar">
                <div
                  className="progress"
                  style={{
                    width: `${Math.ceil(exportInfo.currentPercent)}%`,
                  }}
                ></div>
              </div>
            </div>
...
const PopupChildren = () => {
  ...
  return (
    <p>
      The browser might not be able to handle all categories at once, so the
      website breaks it up into multiple zip files <br />
      ...
      (MB){" "}
      <button
        onClick={() => updateMaxExportSize(defaultSettings.maxExportSize)}
      >
        reset
      </button>
    </p>
