      ...
      {theme === "senior" ? (
        <div className="extraOptions">
          <div className="audioImage">
            <button>
              <label htmlFor="audioImageInput">change audio image</label>
            </button>
            <button
              onClick={() => {
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                if (!file.type.startsWith("image/"))
                  return toast("❌File is not a standard image file");
          ...
          <div className="introMusic">
            <button>
              <label htmlFor="introMusicInput">change intro music</label>
            </button>
            <button
              onClick={() => {
