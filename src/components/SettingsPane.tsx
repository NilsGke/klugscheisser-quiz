      ...
      <div className="settings">
        ...
        <div className="content">
          ...
          <div className="setting">
            ...
            <Switch
              checkedIcon={<img src={cycleIcon} alt="cycle icon" />}
              uncheckedIcon={<img src={cursorClickIcon} alt="click icon" />}
              onChange={(auto) =>
                changeSetting({
          ...
          <div className="setting">
            <p className="description">Auto-Skip on multiple images</p>
            <Switch
              checkedIcon={<img src={cycleIcon} alt="cycle icon" />}
              uncheckedIcon={<img src={cursorClickIcon} alt="click icon" />}
              onChange={(auto) =>
          ...
          <div className="setting">
            ...
            <Switch
              checkedIcon={<img src={stopwatchIcon} alt="stopwatchIcon icon" />}
              uncheckedIcon={<img src={closeIcon} alt="no stopwatch icon" />}
              onChange={(value) =>
                changeSetting({
                  useAnswerTime: value,
                })
