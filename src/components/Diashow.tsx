...
const Diashow = ({
  ...
  const cellSize = Math.round(100 / Math.ceil(Math.sqrt(images.length))) + "%";
    ...
    <>
      <div className="diashow">
        ...
        {edit ? (
          <>
            <div className="edit">
              <button className="big" onClick={() => setEditorOpen(true)}>
                ...
                {images
                  ...
                  .map((image, index) => (
                    <ResourceRenderer
                      ...
                      style={{
                        left: `calc(40% / ${images.length} * ${
                          images.length - 1 - index
                        })`,
                        filter: `brightness(${
                          (100 * (1 / images.length) * (index + 1)) / 2 + 50
                        }%)`,
                      }}
                    />
                  ))}
            ...
            >
              <div className="editor">
                <button className="close" onClick={() => setEditorOpen(false)}>
                    ...
                    >
                      ...
                      <div className="controls">
                        {index !== 0 ? (
                          ...
                          >
                            <img src={moveIcon} alt="move left" />
                          </button>
                        ) : null}
                        ...
                        {index !== images.length - 1 ? (
                          <button
                            ...
                            onClick={() => move(index, 1)}
                          >
                            <img src={moveIcon} alt="move right" />
                          </button>
                        ) : null}
                      </div>
                    </div>
